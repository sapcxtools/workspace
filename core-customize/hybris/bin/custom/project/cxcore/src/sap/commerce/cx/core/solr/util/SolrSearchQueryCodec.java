package sap.commerce.cx.core.solr.util;
 ...
 * This was done so that we have this class accessible to our Facade Layer classes (while the Original Class stays in
 * the WebContext and hence is not reachable from Facade Layer)
 */
