...
public interface CxIndexerService {
     ...
     * @throws IndexerException
     */
    void performIndexForIndexedTypes(FacetSearchConfig facetSearchConfig, IndexOperation indexOperation, List<String> indexedTypeNameList, Map<String, String> indexerHints) throws IndexerException;
